...
public class DefResourceController extends SuperController<DefResourceService, Long, DefResource, DefResourceSaveVO, DefResourceUpdateVO, DefResourcePageQuery, DefResourceResultVO> {
    ...
    @Operation(summary = "清理指定应用下的资源缓存", description = "清理指定应用下的资源缓存")
    @PostMapping("/clearCache")
    @WebLog("清理指定应用下的资源缓存")
    public R<Boolean> clearCache(@RequestParam Long applicationId) {
        superService.clearCache(applicationId);
        return success();
    }
