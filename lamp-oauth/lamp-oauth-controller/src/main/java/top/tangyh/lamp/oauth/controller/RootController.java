...
public class RootController {
    ...
    public R<LoginResultVO> switchTenantAndOrg(@RequestParam Long tenantId,
                                               @RequestParam(required = false) Long orgId) {
        return R.success(tokenGranterBuilder.getGranter(GrantType.PASSWORD).switchTenantAndOrg(tenantId, orgId));
    }
