...
public abstract class AbstractTokenGranter implements TokenGranter {
    ...
    public R<LoginResultVO> login(LoginParamVO loginParam) {
        ...
        Map<Object, Object> extra = result.getExtra();
        String name = Convert.toStr(extra.get("name"));
        String clientId = Convert.toStr(extra.get("clientId"));
    ...
    protected R<LoginResultVO> checkClient() {
        ...
        return R.<LoginResultVO>success(null).put("clientId", defClient.getClientId()).put("name", defClient.getName());
    }
