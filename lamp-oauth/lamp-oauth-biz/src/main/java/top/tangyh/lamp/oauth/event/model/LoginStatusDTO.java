...
public class LoginStatusDTO implements Serializable {
    ...
    public static LoginStatusDTO success(Long userId, Long tenantId, Long employeeId) {
        return LoginStatusDTO.builder()
                .userId(userId).tenantId(tenantId).employeeId(employeeId)
                .status(LoginStatusEnum.SUCCESS.getCode()).description("登录成功")
                .build().setInfo();
    }

    public static LoginStatusDTO switchTenant(Long userId, Long tenantId, Long employeeId) {
        return LoginStatusDTO.builder()
                .userId(userId).tenantId(tenantId).employeeId(employeeId)
    ...
    public static LoginStatusDTO fail(Long tenantId, Long userId, LoginStatusEnum status, String description) {
        return LoginStatusDTO.builder()
                .userId(userId)
                .tenantId(tenantId)
    ...
    public static LoginStatusDTO fail(Long tenantId, String username, LoginStatusEnum status, String description) {
        return LoginStatusDTO.builder()
                .tenantId(tenantId)
                .username(username)
                .status(status.getCode()).description(description)
