...
1. 将 lamp-cloud-pro 导入IDEA
2. 将 lamp-util-max 导入IDEA
...
mvn versions:set -DnewVersion="5.4.0" -DskipTests -DgenerateBackupPoms=false

mvn versions:set -DnewVersion="5.4.0-SNAPSHOT" -DskipTests -DgenerateBackupPoms=false
