...
import top.tangyh.lamp.boot.interceptor.AuthenticationSaInterceptor;
import top.tangyh.lamp.boot.interceptor.TokenContextFilter;
...
public class BootWebConfiguration implements WebMvcConfigurer {
    ...
    public void addInterceptors(InterceptorRegistry registry) {
        ...
        registry.addInterceptor(getSaFilter())
                .addPathPatterns("/**")
                .order(10)
                .excludePathPatterns(commonPathPatterns);
